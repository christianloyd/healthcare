/* ============================================================================
   Child Record Index - JavaScript (BHW Version)
   Extracted from: resources/views/shared/childrecord/index.blade.php

   NOTE: Blade Routes (must be handled via config object):
   - {{ route('bhw.childrecord.create') }}
   - {{ route('bhw.childrecord.index') }}
   - {{ route('bhw.childrecord.search') }}
   ============================================================================ */
 ...
 * - Replace {{ route('bhw.childrecord.search') }} with your configured route
 */
